         ...
         {selectedValue.map(value=>{
           return (
            <tr key={value[0]}>
              ...
              <td>                              
                {!(value[1].total.deceased)?(Number(value[1].total.confirmed)-Number(value[1].total.recovered)):(Number(value[1].total.confirmed)-(Number(value[1].total.recovered)+Number(value[1].total.deceased)))}
              </td>
              <td>
                {Number(value[1].total.recovered)}  
              </td>
              <td>
